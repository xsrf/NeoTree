@echo off
echo This will set the Fuses and write the USB Bootloader to the chip!
...
%userprofile%/.platformio/packages/tool-avrdude/avrdude.exe -c usbasp -B4 -p t85 -v -U flash:w:t85_fastexit.hex
